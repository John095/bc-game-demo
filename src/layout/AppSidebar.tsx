...
const navItems: NavItem[] = [
  {
    ...
    name: "Sports",
    subItems: [
      { name: "Football", path: "", icon: <PiSoccerBallDuotone />, },
      { name: "Tennis", path: "", icon: <PiTennisBallDuotone />, },
      { name: "Basketball", path: "", icon: <PiBasketballDuotone />, },
      { name: "Cricket", path: "", icon: <PiCricketDuotone />, },
      { name: "Boxing", path: "", icon: <PiBoxingGloveDuotone />, },
      { name: "NFL", path: "", icon: <PiFootballDuotone />, }
  ...
  },
  {
    ...
    name: "Lottery",
    subItems: [
      { name: "All Lotteries", path: "", icon: <GiMoneyStack />, },
      { name: "BC Lottery", path: "", icon: <GiTakeMyMoney />, },
      { name: "Popular", path: "", icon: <BsStars />, },
    ],
  },
  {
  ...
  //   name: "Forms",
  //   icon: <ListIcon />,
  //   subItems: [{ name: "Form Elements", path: "/form-elements", icon: <GridIcon />, }],
  // },
  // {
  //   name: "Tables",
  //   icon: <TableIcon />,
  //   subItems: [{ name: "Basic Tables", path: "/basic-tables", icon: <GridIcon />, }],
  // },
  // {
  //   name: "Pages",
  //   icon: <PageIcon />,
